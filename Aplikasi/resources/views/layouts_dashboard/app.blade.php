        ...
        <div class="d-flex" id="wrapper">
            ...
            <div class="border-end bg-white" id="sidebar-wrapper">
                ...
                <div class="sidebar-nav list-group list-group-flush">
                    ...
                    <a class="list-group-item list-group-item-action list-group-item-light {{ request()->is('admin/dashboard') ? 'active-nav' : '' }}" href="/dashboard">
                    ...
                    <a class="list-group-item list-group-item-action list-group-item-light {{ request()->is('admin/laporan') ? 'active-nav' : '' }}" href="/laporan">
                    ...
                    <a class="list-group-item list-group-item-action list-group-item-light {{ request()->is('admin/kamar') ? 'active-nav' : '' }}" href="/kamar">
